                            ...
                            <div class="product-item">
                                <div class="single-product">
                                    <div class="product-img">
                                        <a href=<?=Url::toRoute(['/shop/single-product'])?>>
                                            <img class="primary-img" src="./../images/product/1-1.png" alt=<?=$data->title?>>>
                                            <img class="secondary-img" src="./../images/product/1-2.png" alt=<?=$data->title?>>
                                        </a>
                                    ...
                                    <div class="product-content">
                                        <div class="product-desc_info">
                                            <h3 class="product-name"><a href=<?=Url::toRoute(['/shop/single-product'])?>><?=$data->title?></a></h3>
                                            <div class="price-box">
